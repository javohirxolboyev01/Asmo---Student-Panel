      ...
      <label htmlFor={checkboxId} className="inline-flex items-center gap-2 cursor-pointer select-none">
        <span className="relative inline-flex items-center justify-center w-5 h-5 flex-shrink-0">
          <input
            ...
            type="checkbox"
            className={cn(
              "peer appearance-none w-5 h-5 rounded-md border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-white/5 checked:bg-primary-500 checked:border-primary-500 transition-colors cursor-pointer",
              className,
            )}
            {...props}
          />
